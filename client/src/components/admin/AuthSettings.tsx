  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="bg-background rounded-lg shadow p-6">
        <h2 className="text-base font-semibold text-foreground">认证设置</h2>
        <p className="mt-1 text-sm text-muted-foreground">所有配置运行时生效，无需重启服务。总开关 AUTH_ENABLED 在服务端 .env 中配置。</p>
          ...
          {FIELDS.map((f) => (
            <div key={f.key}>
              ...
              <input
                ...
                className="mt-1 w-full px-3 py-2 border border-input rounded-lg text-sm focus:outline-none focus:border-primary"
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <button
            onClick={load}
            className="px-4 py-2 border border-input rounded-lg text-sm text-foreground hover:border-primary hover:text-primary"
          >
            重置
          </button>
