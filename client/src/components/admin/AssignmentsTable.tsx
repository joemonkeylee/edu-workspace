...
const STATUS_CLASS: Record<string, string> = {
  ...
  returned: 'bg-amber-100 dark:bg-amber-950/60 dark:border dark:border-amber-800 text-amber-700 dark:text-amber-400',
      ...
      {viewMode === 'book' ? (
        <div className="space-y-3">
          {loading ? (
            ...
            <>
              {total > items.length && (
                <p className="px-3 py-2 text-xs rounded-lg text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/50 dark:border dark:border-amber-800 border border-amber-200 dark:border-amber-800">
